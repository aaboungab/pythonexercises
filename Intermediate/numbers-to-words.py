print("         NUM2WORDS CONVERTER      \n")

#Ask for a number
print("Type in any number: ")
integer = input()

#Create num2words function to store conversion
def num2words(integer):
    ...
    #Loop to add 3 everything to integer_change & change
...
#store num2words in a variable
converter = num2words(integer)
